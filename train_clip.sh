...
python3 src/clip_model/evaluate.py --test_data data/memes/test.csv  --images_path data/memes/images  --bs 20 --only_prefix --normalize_prefix --device cpu > output/clip_memes_mlponly_test10ep.log
